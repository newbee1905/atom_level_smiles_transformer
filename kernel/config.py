...
The configurations are designed to provide good performance across a wide range of GPUs,
from high-end datacenter cards (H100/A100) to consumer-grade and laptop GPUs (L40S, 3090, 1650).
"""
...
def get_rope_autotune_configs():
	"""
	Returns a list of Triton configs specifically for RoPE kernel autotuning.
